...
minetest.register_tool("lottarmor:shield_wood", {
	...
	groups = {armor_shield=1, armor_heal=0, armor_use=2000, armor_healing=0, physics_speed=0.04},
	wear = 0,
})
...
minetest.register_tool("lottarmor:shield_tin", {
	...
	groups = {armor_shield=3, armor_heal=0, armor_use=1750, armor_healing=0},
	wear = 0,
})
...
minetest.register_tool("lottarmor:shield_steel", {
	...
	groups = {armor_shield=5, armor_heal=0, armor_use=1250, armor_healing=0},
	wear = 0,
})
...
minetest.register_tool("lottarmor:shield_bronze", {
	...
	groups = {armor_shield=6, armor_heal=0, armor_use=750, armor_healing=0},
	wear = 0,
})
...
minetest.register_tool("lottarmor:shield_silver", {
	...
	groups = {armor_shield=7, armor_heal=0, armor_use=1000, armor_healing=0, physics_speed=-0.05},
	wear = 0,
})
...
minetest.register_tool("lottarmor:shield_gold", {
	...
	groups = {armor_shield=7, armor_heal=0, armor_use=500, armor_healing=0, physics_speed=-0.05},
	wear = 0,
})
...
minetest.register_tool("lottarmor:shield_galvorn", {
	...
	groups = {armor_shield=7, armor_heal=0, armor_use=250, armor_healing=0, physics_speed=-0.1, physics_sneak=-1, forbidden=1},
	wear = 0,
})
...
minetest.register_tool("lottarmor:shield_mithril", {
	...
	groups = {armor_shield=12, armor_heal=0, armor_use=100, armor_healing=0, physics_speed=-0.1, physics_sneak=-1, forbidden=1},
	wear = 0,
})

minetest.register_tool("lottarmor:shield_thorium", {
	description = "Thorium Shield",
	inventory_image = "lottarmor_inv_shield_thorium.png",
	groups = {armor_shield=17, armor_heal=0, armor_use=100, armor_healing=0, physics_speed=-0.1, physics_sneak=-1, forbidden=1},
	wear = 0,
})
