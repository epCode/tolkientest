...
-- Tom has no use for metals and ores.  He does like to smoke!

lottmobs.bombadil = {
	items = {
		{"lottores:mithril_ingot 4", "lottfarming:pipeweed_cooked 25", 10},
		
		{"lottores:tilkal_ingot 4", "lottfarming:pipeweed_cooked 25", 10},
		{"lottores:galvorn_ingot 4", "lottfarming:pipeweed_cooked 25", 10},
		
		{"default:goldblock 1", "lottfarming:pipeweed_cooked 25", 15},
		{"lottores:silver_block 1", "lottfarming:pipeweed_cooked 25", 15},
...
lottmobs.galadriel = {
	items = {
		{"lottother:red_gem 1", "lottores:pearl 2", 33},
		{"lottother:blue_gem 1", "lottores:pearl 2", 33},
		{"lottother:white_gem 1", "lottores:pearl 2", 33},
		
		{"lottblocks:elf_torch 20", "lottores:rough_rock_lump 5", 20},
		
		{"lottother:ringsilver 10", "lottores:galvorn_ingot 8", 40},
		
		{"lottores:rough_rock_lump 10", "lottores:galvorn_ingot 2", 30},
		
		{"lottother:elfstone 1", "lottores:tilkal_ingot 40", 30},
		
		{"lottores:ithildin_1 10", "lottplants:mallornsapling 2", 25},
		
		{"lottplants:mallorntree 50", "lottblocks:elf_torch 8", 25},
		
		{"lottblocks:small_lamp_mallorn 2", "lottplants:mallornleaf 60", 25},
		{"lottthrowing:bow_wood_mallorn 1", "lottplants:elanor 2", 25},
		{"lottblocks:mallorn_pillar 30", "lottores:silver_ingot 40", 25},
		
		{"lottblocks:elven_rope 60", "lottores:silver_ingot 8", 25},
		
		{"lottweapons:elven_sword 1", "lottores:tilkal_ingot 2", 25},
	...
	items_race = {
		...
		{"lottplants:mallorn 50", "lottblocks:elf_torch 8", 25},
	...
	messages = {
		"I come to you last who are not last in my thoughts. For you I have prepared this.",
		...
		"In this phial is caught the light of Earendil’s star, set amid the waters of my fountain.",
		"Life here is far from normal. We wish for peace, yet the only way we can get peace is through war...",
