function lottinventory.get_potion_formspec(player, page)
	if page=="potions" then
     ...
     if page=="potions7" then
		return "size[8,5.5]"
               ...
               .."image_button[7,1;1,1;zcg_next.png;potions8;;false;false;zcg_next_press.png]"
	...
	if page=="potions8" then
		return "size[8,5.5]"
               .."label[0,0;Book of Potions]"
               .."button_exit[6,0;2,0.5;quit;Exit]"
               .."image[7,1;1,1;zcg_next_inactive.png]"
               .."image_button[6,1;1,1;zcg_previous.png;potions7;;false;false;zcg_previous_press.png]"
               .."label[0,0.5;Kingsfoil (Revives nearby players)]"
               -- Kingsfoil
               .."label[1,2.2; Kingsfoil]"
               .."item_image_button[4,2;1,1;lottpotion:glass_bottle_geodes;zcg:glass_bottle_geodes;]"
               .."item_image_button[5,2;1,1;lottfarming:athelas;zcg:athelas;10]"
               .."image[6,2;1,1;zcg_craft_arrow.png]"
               .."item_image_button[7,2;1,1;lottpotion:kingsfoil;zcg:kingsfoil;]"
...
minetest.register_on_player_receive_fields(function(player,formname,fields)
	...
	if fields.potions8 then
		minetest.show_formspec(pn, "potions",
			lottinventory.get_potion_formspec(player, "potions8"))
	end
end)
