local dragondef = {
   ...
   animation = {
	...
	knock_back = 2,
	do_custom = dmobs.dragon.step_custom_red,
...
dragondef.on_rightclick = dmobs.dragon.ride_red
dragondef.do_custom = dmobs.dragon.do_custom_red
