...
dofile(minetest.get_modpath("lottthrowing").."/elvish_arrow.lua")
...
-- Code stolen from binoculars mod for Elvish Bow
...
function lottthrowing.update_player_property(player)
	local creative_enabled = creative_mode_cache
	local new_zoom_fov = 0

	if player:get_inventory():contains_item("main", "lottthrowing:bow_elvish") then
		new_zoom_fov = 10
	end
...
minetest.register_on_joinplayer(function(player)
	lottthrowing.update_player_property(player)
end)
