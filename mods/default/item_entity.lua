...
core.register_entity(":__builtin:item", {
    ...
    if ItemStack(self.itemstring):get_name() then
      local name = ItemStack(self.itemstring):get_name()
      if minetest.registered_items[name] and minetest.registered_items[name].noitem then
        self.object:remove()
        return
      end
    end
